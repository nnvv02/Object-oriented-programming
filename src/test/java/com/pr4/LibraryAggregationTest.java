...
class LibraryAggregationTest {
    ...
    void shouldIncreaseQuantityWhenBookAlreadyExists() {
        ...
        library.addNewBook(new GeneralBook("Dune", "Frank Herbert", 1965, 412, BookGenre.SCI_FI), 3);
    ...
    void shouldAggregateDuplicatesFromLoadedList() {
        ...
        loaded.add(new GeneralBook("1984", "George Orwell", 1949, 328, BookGenre.FICTION));
        loaded.add(new GeneralBook("1984", "George Orwell", 1949, 328, BookGenre.FICTION));
        loaded.add(new GeneralBook("Clean Code", "Robert C. Martin", 2008, 464, BookGenre.NON_FICTION));

        library.addAllBooks(loaded);

        assertEquals(2, library.getBookCount());
        assertEquals(3, library.getTotalQuantity());
        assertEquals(2, library.getQuantity(new GeneralBook("1984", "George Orwell", 1949, 328, BookGenre.FICTION)));
    }
